...
curl localhost:4567/api/hello?name=Steven+Gerrard
```
...
aws ecr get-login-password --region us-east-1 | docker login \
 --username AWS \
 --password-stdin 982383527471.dkr.ecr.us-east-1.amazonaws.com
 ```
...
docker tag python:3.13.0a6-slim-bookworm 982383527471.dkr.ecr.us-east-1.amazonaws.com/python:3.13.0a6-slim-bookworm
docker push 982383527471.dkr.ecr.us-east-1.amazonaws.com/python:3.13.0a6-slim-bookworm
```
...
```sh
docker build -t  app .
docker tag app:latest 982383527471.dkr.ecr.us-east-1.amazonaws.com/app:latest
docker push 982383527471.dkr.ecr.us-east-1.amazonaws.com/app:latest
```
