  ...
  */
  ...
  constructor(scope: Construct, id: string, props: HecDynamoDbProps) {
    super(scope, id, {
      ...
      removalPolicy: props.removalPolicy || cdk.RemovalPolicy.DESTROY, // NOT ideal for prod env
      // Allows for recovery of deleted data
      pointInTimeRecovery: props.pointInTimeRecovery !== undefined ? props.pointInTimeRecovery : true,
    });
